...
df = pd.DataFrame("./Data/Survey_data.csv")
...
df.rename(columns={'Q78_1': 'Sports_Concussion_Info'}, inplace=True)
df.rename(columns={'Q84': 'No_Sports_Concussion_Status'}, inplace=True)
df.rename(columns={'Q84_1': 'No_Sports_Concussion_Info'}, inplace=True)
...
df.rename(columns={'Q64.1': 'Breath_pause'}, inplace=True)
